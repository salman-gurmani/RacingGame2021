  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord1.w = 0;
          out_v.texcoord2.xy = float2(in_v.texcoord.xy);
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = float2(TRANSFORM_TEX(in_f.texcoord2.xy, _Albedo03));
          u_xlat10_0.xyz = tex2D(_Albedo03, u_xlat0_d.xy).xyz.xyz;
          u_xlat1_d.xy = float2(TRANSFORM_TEX(in_f.texcoord2.xy, _Albedo01));
          u_xlat10_1.xyz = tex2D(_Albedo01, u_xlat1_d.xy).xyz.xyz;
          u_xlat2.xy = float2(TRANSFORM_TEX(in_f.texcoord2.xy, _Albedo02));
          u_xlat10_2.xyz = tex2D(_Albedo02, u_xlat2.xy).xyz.xyz;
          u_xlat3.xy = float2(TRANSFORM_TEX(in_f.texcoord2.xy, _SplatMap01));
          u_xlat10_3 = tex2D(_SplatMap01, u_xlat3.xy);
          u_xlat16_4.xyz = float3((u_xlat10_2.xyz * u_xlat10_3.yyy));
          u_xlat16_4.xyz = float3(((u_xlat10_3.xxx * u_xlat10_1.xyz) + u_xlat16_4.xyz));
          u_xlat16_4.xyz = float3(((u_xlat10_3.zzz * u_xlat10_0.xyz) + u_xlat16_4.xyz));
          u_xlat0_d.xy = float2(TRANSFORM_TEX(in_f.texcoord2.xy, _Albedo04));
          u_xlat10_0.xyz = tex2D(_Albedo04, u_xlat0_d.xy).xyz.xyz;
          u_xlat16_4.xyz = float3(((u_xlat10_3.www * u_xlat10_0.xyz) + u_xlat16_4.xyz));
          u_xlat16_4.xyz = float3((u_xlat16_4.xyz * _LightColor0.xyz));
          u_xlat16_19 = dot(in_f.texcoord.xyz, _WorldSpaceLightPos0.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord.xyz = float3(normalize(u_xlat1.xyz));
          out_v.texcoord1.xyz = float3(((conv_mxt4x4_3(unity_ObjectToWorld).xyz * in_v.vertex.www) + u_xlat0.xyz));
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2(TRANSFORM_TEX(in_f.texcoord2.xy, _Albedo01));
          u_xlat10_1.xyz = tex2D(_Albedo01, u_xlat1_d.xy).xyz.xyz;
          u_xlat2_d.xy = float2(TRANSFORM_TEX(in_f.texcoord2.xy, _Albedo02));
          u_xlat10_2.xyz = tex2D(_Albedo02, u_xlat2_d.xy).xyz.xyz;
          u_xlat3.xy = float2(TRANSFORM_TEX(in_f.texcoord2.xy, _SplatMap01));
          u_xlat10_3 = tex2D(_SplatMap01, u_xlat3.xy);
          u_xlat16_4.xyz = float3((u_xlat10_2.xyz * u_xlat10_3.yyy));
          u_xlat16_4.xyz = float3(((u_xlat10_3.xxx * u_xlat10_1.xyz) + u_xlat16_4.xyz));
          ...
          u_xlat10_0.xyz = tex2D(_Albedo04, u_xlat0_d.xy).xyz.xyz;
          u_xlat16_4.xyz = float3(((u_xlat10_3.www * u_xlat10_0.xyz) + u_xlat16_4.xyz));
          u_xlat0_d.xyz = float3((in_f.texcoord1.yyy * conv_mxt4x4_1(unity_WorldToLight).xyz));
          u_xlat0_d.xyz = float3(((conv_mxt4x4_0(unity_WorldToLight).xyz * in_f.texcoord1.xxx) + u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3(((conv_mxt4x4_2(unity_WorldToLight).xyz * in_f.texcoord1.zzz) + u_xlat0_d.xyz));
          ...
          u_xlat0_d.xyz = float3(((-in_f.texcoord1.xyz) + _WorldSpaceLightPos0.xyz));
          u_xlat0_d.xyz = float3(normalize(u_xlat0_d.xyz));
          u_xlat16_22 = dot(in_f.texcoord.xyz, u_xlat0_d.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          u_xlat0 = ((conv_mxt4x4_2(unity_ObjectToWorld) * in_v.vertex.zzzz) + u_xlat0);
          u_xlat1 = (u_xlat0 + conv_mxt4x4_3(unity_ObjectToWorld));
          out_v.texcoord.xyz = float3(((conv_mxt4x4_3(unity_ObjectToWorld).xyz * in_v.vertex.www) + u_xlat0.xyz));
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = float2(TRANSFORM_TEX(in_f.texcoord1.xy, _Albedo03));
          u_xlat10_0.xyz = tex2D(_Albedo03, u_xlat0_d.xy).xyz.xyz;
          u_xlat1_d.xy = float2(TRANSFORM_TEX(in_f.texcoord1.xy, _Albedo01));
          u_xlat10_1.xyz = tex2D(_Albedo01, u_xlat1_d.xy).xyz.xyz;
          u_xlat2.xy = float2(TRANSFORM_TEX(in_f.texcoord1.xy, _Albedo02));
          u_xlat10_2.xyz = tex2D(_Albedo02, u_xlat2.xy).xyz.xyz;
          u_xlat3.xy = float2(TRANSFORM_TEX(in_f.texcoord1.xy, _SplatMap01));
          u_xlat10_3 = tex2D(_SplatMap01, u_xlat3.xy);
          u_xlat16_4.xyz = float3((u_xlat10_2.xyz * u_xlat10_3.yyy));
          u_xlat16_4.xyz = float3(((u_xlat10_3.xxx * u_xlat10_1.xyz) + u_xlat16_4.xyz));
          u_xlat16_4.xyz = float3(((u_xlat10_3.zzz * u_xlat10_0.xyz) + u_xlat16_4.xyz));
          u_xlat0_d.xy = float2(TRANSFORM_TEX(in_f.texcoord1.xy, _Albedo04));
          u_xlat10_0.xyz = tex2D(_Albedo04, u_xlat0_d.xy).xyz.xyz;
          u_xlat16_4.xyz = float3(((u_xlat10_3.www * u_xlat10_0.xyz) + u_xlat16_4.xyz));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = float2(TRANSFORM_TEX(in_f.texcoord2.xy, _Albedo04));
          u_xlat10_0.xyz = tex2D(_Albedo04, u_xlat0_d.xy).xyz.xyz;
          out_f.color.xyz = float3(((u_xlat10_3.www * u_xlat10_0.xyz) + u_xlat16_4.xyz));
          out_f.color.w = 1;
          out_f.color1 = float4(0, 0, 0, 0);
          u_xlat0_d.xyz = float3(((in_f.texcoord.xyz * float3(0.5, 0.5, 0.5)) + float3(0.5, 0.5, 0.5)));
          u_xlat0_d.w = 1;
