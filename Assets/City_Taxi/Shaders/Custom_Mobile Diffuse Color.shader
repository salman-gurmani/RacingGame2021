  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1.xyz = float3((u_xlat16_0.xyz * _LightColor0.xyz));
          u_xlat16_7 = dot(in_f.texcoord1.xyz, _WorldSpaceLightPos0.xyz);
          u_xlat16_7 = max(u_xlat16_7, 0);
          out_f.color.xyz = float3((float3(u_xlat16_7, u_xlat16_7, u_xlat16_7) * u_xlat16_1.xyz));
          out_f.color.w = 1;
          return out_f;
      }
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1_d.xyz = float3(max(u_xlat10_0.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_1_d.xyz = float3(log2(u_xlat16_1_d.xyz));
          u_xlat0_d.xyz = float3(((-u_xlat16_1_d.xyz) + in_f.texcoord4.xyz));
          u_xlat10_2.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz.xyz;
          u_xlat16_2_d.xyz = float3((u_xlat10_2.xyz * _Color.xyz));
          out_f.color.xyz = float3((u_xlat0_d.xyz * u_xlat16_2_d.xyz));
          out_f.color.w = 1;
          return out_f;
      }
