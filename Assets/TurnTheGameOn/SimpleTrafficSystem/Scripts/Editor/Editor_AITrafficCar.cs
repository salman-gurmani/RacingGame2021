        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (tab)
            {
                ...
                case 1:
                    ...
                    if (GUILayout.Button(new GUIContent("Auto Rig Brake Mesh", "Find the mesh, and material index that has the matching 'Brake Light' material name, set in Preferences.")))
                    {
                        AutoRigBrakeMesh();
                    }
                    EditorGUILayout.EndVertical();
                    ...
                    if (GUILayout.Button(new GUIContent("Auto Rig Wheel Mesh", "Find the meshes that have the matching 'Wheel' names, set in Preferences.")))
                    {
                        AutoRigWheelMesh();
                    }
