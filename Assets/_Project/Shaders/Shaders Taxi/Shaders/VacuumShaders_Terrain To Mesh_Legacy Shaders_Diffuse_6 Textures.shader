Shader "VacuumShaders/Terrain To Mesh/Legacy Shaders/Diffuse/6 Textures"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      uniform float _V_T2M_Splat6_uvScale;
      ...
      uniform sampler2D _V_T2M_Splat6;
      struct appdata_t
      {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d = (in_f.texcoord.zwzw * float4(_V_T2M_Splat5_uvScale, _V_T2M_Splat5_uvScale, _V_T2M_Splat6_uvScale, _V_T2M_Splat6_uvScale));
          u_xlat10_2.xyz = tex2D(_V_T2M_Splat5, u_xlat1_d.xy).xyz.xyz;
          u_xlat10_1.xyz = tex2D(_V_T2M_Splat6, u_xlat1_d.zw).xyz.xyz;
          u_xlat10_3.xy = tex2D(_V_T2M_Control2, in_f.texcoord.zw).xy.xy;
          u_xlat16_0.xyz = float3(((u_xlat10_2.xyz * u_xlat10_3.xxx) + u_xlat16_0.xyz));
          u_xlat16_0.xyz = float3(((u_xlat10_1.xyz * u_xlat10_3.yyy) + u_xlat16_0.xyz));
