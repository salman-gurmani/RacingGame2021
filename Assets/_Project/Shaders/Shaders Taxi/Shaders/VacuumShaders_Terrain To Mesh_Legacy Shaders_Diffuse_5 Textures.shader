Shader "VacuumShaders/Terrain To Mesh/Legacy Shaders/Diffuse/5 Textures"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      uniform float4 _V_T2M_Control2_ST;
      ...
      uniform float _V_T2M_Splat5_uvScale;
      ...
      uniform sampler2D _V_T2M_Control2;
      uniform sampler2D _V_T2M_Splat5;
      struct appdata_t
      {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord.zw = TRANSFORM_TEX(in_v.texcoord.xy, _V_T2M_Control2);
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2((in_f.texcoord.zw * float2(_V_T2M_Splat5_uvScale, _V_T2M_Splat5_uvScale)));
          u_xlat10_1.xyz = tex2D(_V_T2M_Splat5, u_xlat1_d.xy).xyz.xyz;
          u_xlat10_15 = tex2D(_V_T2M_Control2, in_f.texcoord.zw).x;
          u_xlat16_0.xyz = float3(((u_xlat10_1.xyz * float3(u_xlat10_15, u_xlat10_15, u_xlat10_15)) + u_xlat16_0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2((in_f.texcoord.zw * float2(_V_T2M_Splat5_uvScale, _V_T2M_Splat5_uvScale)));
          u_xlat10_1.xyz = tex2D(_V_T2M_Splat5, u_xlat1_d.xy).xyz.xyz;
          u_xlat10_18 = tex2D(_V_T2M_Control2, in_f.texcoord.zw).x;
          u_xlat16_0.xyz = float3(((u_xlat10_1.xyz * float3(u_xlat10_18, u_xlat10_18, u_xlat10_18)) + u_xlat16_0.xyz));
          u_xlat16_4.xyz = float3((u_xlat16_0.xyz * _Color.xyz));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = float2((in_f.texcoord.zw * float2(_V_T2M_Splat5_uvScale, _V_T2M_Splat5_uvScale)));
          u_xlat10_1.xyz = tex2D(_V_T2M_Splat5, u_xlat1_d.xy).xyz.xyz;
          u_xlat10_12 = tex2D(_V_T2M_Control2, in_f.texcoord.zw).x;
          u_xlat16_0.xyz = float3(((u_xlat10_1.xyz * float3(u_xlat10_12, u_xlat10_12, u_xlat10_12)) + u_xlat16_0.xyz));
